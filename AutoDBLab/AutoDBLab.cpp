...
// AutoDBLab.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAutoDBLabApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAutoDBLabApp::OnAppAbout)
...
// Создание CAutoDBLabApp

CAutoDBLabApp::CAutoDBLabApp() noexcept
{
	...
	SetAppID(_T("AutoDBLab.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CAutoDBLabApp

CAutoDBLabApp theApp;


// Инициализация CAutoDBLabApp

BOOL CAutoDBLabApp::InitInstance()
{
...
int CAutoDBLabApp::ExitInstance()
{
...
// Обработчики сообщений CAutoDBLabApp
